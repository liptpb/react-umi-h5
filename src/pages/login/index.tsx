...
//   render() {
//     const {fromIn, phone, phoneIsFocus, phoneError, imgCode, codeImageUrl, imgCodeIsFocus, imgCodeError, phoneCode, phoneCodeIsFocus, codeText, isWait} = this.state;
...
//             <Form.Item
//               name='cph'
//               rules={[{ required: true, message: '请账号' }]}
//             >
//               <Input />
//             </Form.Item>
//           </Form.Item>
...
//           <div className={style['input-wrap-flex']}>
//             <div className="left">
//               <CSSTransition
//                 in={imgCode.length > 0}
//                 timeout={400}
...
//             </div>
//             <div className="right">
//               <span className={style['code-info', {'gray-info': isWait, 'active-info': codeText === '重新获取'}]}
